...
while(true)
{
   ...
   else
   {
      ...
      {
         set("\x01",eval("\x01") + 66);
         Object.registerClass("Screen_LoadingWorld",Screen.CScreen_LoadingWorld);
         break;
      }
      if(eval("\x01") == 699)
      {
            ...
            while(true)
            {
               ...
               else
               {
                  ...
                  else
                  {
                     ...
                     {
                        set("\x01",eval("\x01") + 57);
                        Object.registerClass("Piece.Column2",World.Init.CWorld_Init_Piece);
                        break;
                     }
                     if(eval("\x01") == 118)
                     {
         ...
         if(eval("\x01") == 718)
         {
            ...
            while(true)
            {
               ...
               while(true)
               {
                                    ...
                                    while(§§pop() != §§pop())
                                    {
                                       ...
                                       else
                                       {
                                          if(eval("\x01") == 609)
                                          {
                                             ...
                                             Object.registerClass("Piece.Slab_Large",World.Init.CWorld_Init_Piece);
                                             return;
                                          }
                                          if(eval("\x01") == 488)
                                          {
                                          ...
                                          else
                                          {
                                             ...
                                             if(eval("\x01") == 98)
                                             {
                                                ...
                                                Object.registerClass("World_Init_Devil",World.Init.CWorld_Init_Devil);
                                                return;
                                             }
                                             if(eval("\x01") == 928)
                                             {
                  ...
                  {
                     set("\x01",eval("\x01") + 21);
                     Object.registerClass("Piece.Cube1",World.Init.CWorld_Init_Piece);
                     break;
                  }
                  if(eval("\x01") == 851)
                  {
                        ...
                        else
                        {
                           ...
                           if(eval("\x01") != 777)
                           {
                              if(eval("\x01") == 821)
                              {
                                 ...
                                 Object.registerClass("World_Init_Zombie",World.Init.CWorld_Init_Zombie);
                                 break;
                              }
                              if(eval("\x01") == 925)
                              {
