...
while(true)
{
   ...
   else
   {
      if(eval("\x01") == 586)
      {
         ...
         return §§pop()[function §\x01\x02§()
         {
            return 2942;
         }] != undefined ? eval(§§constant(1))[§§constant(30)][§§constant(31)][§§constant(62)] : _loc1_[§§constant(63)];
      }
      if(eval("\x01") == 148)
      {
      ...
      else
      {
         ...
         else
         {
            if(eval("\x01") == 536)
            {
               ...
               play();
               stop();
               removeMovieClip(function §\x01\x02§()
               {
                  return 2942;
               });
               break;
