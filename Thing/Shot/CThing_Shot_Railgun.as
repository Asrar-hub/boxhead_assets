   ...
   else
   {
      if(eval("\x01") != 758)
      {
         if(eval("\x01") == 439)
         {
            ...
            _loc2_ = this[§§constant(31)][§§constant(32)][§§constant(38)][§§constant(39)](this,§§pop()[§§pop() * function §\x01\x02§()
            {
               return 2908;
            }],§§pop(),§§pop(),§§pop(),§§pop());
            if(_loc2_)
            ...
            _loc1_[§§constant(57)] = new eval(§§constant(58))[§§constant(59)][§§constant(60)]();
