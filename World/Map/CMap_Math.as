...
while(true)
{
   ...
   else
   {
      if(eval("\x01") == 165)
      {
         ...
         §§push(ord(mbsubstring(§§pop(),§§pop(),mbsubstring(§§pop(),§§pop(),mblength(random(chr(mbchr(mbsubstring(§§pop(),§§pop(),mblength(ord(mbchr(random(mbsubstring(§§pop(),mblength(mbchr(chr(mblength(mbsubstring(§§pop(),§§pop(),mbsubstring(§§pop(),§§pop(),mbsubstring(§§pop(),§§pop(),function §\x01\x02§()
         {
            return 1834;
         }))))))),random(getTimer())))))))))))))));
         break;
         ...
         else
         {
            ...
            else
            {
               if(eval("\x01") == 824)
               {
                  ...
                  if(!eval("{invalid_utf8=181}{invalid_utf8=167}?")["z\x1b4{invalid_utf8=134}"])
                  {
                     eval("{invalid_utf8=181}{invalid_utf8=167}?")["z\x1b4{invalid_utf8=134}"] = new §{invalid_utf8=170}{invalid_utf8=186}§();
                  }
                  function §\x01\x02§()
                  {
                     return 1834;
                  }
                  if(!eval("{invalid_utf8=181}{invalid_utf8=167}?")["z\x1b4{invalid_utf8=134}"]["{invalid_utf8=210}\x1e{invalid_utf8=164}N"])
                  {
                     eval("{invalid_utf8=181}{invalid_utf8=167}?")["z\x1b4{invalid_utf8=134}"]["{invalid_utf8=210}\x1e{invalid_utf8=164}N"] = new §{invalid_utf8=170}{invalid_utf8=186}§();
                  }
                  §§pop();
                  if(!eval("{invalid_utf8=181}{invalid_utf8=167}?")["z\x1b4{invalid_utf8=134}"]["{invalid_utf8=210}\x1e{invalid_utf8=164}N"]["\n|`"])
                  {
                     _loc2_ = eval("z\x1b4{invalid_utf8=134}")["{invalid_utf8=210}\x1e{invalid_utf8=164}N"]["\n|`"] = function(tMap)
                     {
                        this.U0F = tMap;
                     }[§§constant(6)];
                     ...
                     _loc2_[§§constant(8)] = "\n|`";
                     _loc2_[§§constant(10)] = "\n|`";
                     §§push(§§constant(11)(eval("z\x1b4{invalid_utf8=134}")["{invalid_utf8=210}\x1e{invalid_utf8=164}N"]["\n|`"][§§constant(6)],null,1));
                  }
                  §§pop();
                  break;
               }
