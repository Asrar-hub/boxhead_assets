         ...
         while(true)
         {
               ...
               else
               {
                  if(eval("\x01") != 571)
                  {
                     if(eval("\x01") == 415)
                     {
                        ...
                        Object.registerClass("World_Init_Player1",World.Init.CWorld_Init_Player1);
                        break;
                     }
                     if(eval("\x01") == 104)
                     {
            ...
            while(true)
            {
               ...
               if(eval("\x01") == 489)
               {
                  ...
                  stopDrag();
                  §§push(delete §§pop()[§§pop() == mblength((§§pop() > §§pop())) lt §§dup(mblength((§§pop() > §§pop())))]);
                  break;
               }
               if(eval("\x01") == 215)
               {
      ...
      else
      {
         if(eval("\x01") != 600)
         {
            if(eval("\x01") == 462)
            {
               ...
               Object.registerClass("Piece.Slab",World.Init.CWorld_Init_Piece);
               break;
            }
            if(eval("\x01") == 622)
            {
